...
import { EarthSystem } from "../planetarysystems/earthsystem";
import { HeliocentricGalaxyView } from "../solarsystem/heliocentricgalaxyview";
import { MarsSystem } from "../planetarysystems/marssystem";
import { SolSystem } from "../solarsystem/solsystem";
import { useTimeManager } from "../../libs/utils/timeManager";
import { VenusSystem } from "../planetarysystems/venussystem";
import { MercurySystem } from "../planetarysystems/mercurysystem";
import { JupiterSystem } from "../planetarysystems/jupitersystem";
import { SaturnSystem } from "../planetarysystems/saturnsystem";
import { UranusSystem } from "../planetarysystems/uranussystem";
import { NeptuneSystem } from "../planetarysystems/neptunesystem";

function SolarModelRenderer() {
  ...
  useEffect(() => {
    ...
    solarScene.add(light);

    const pointLight = new THREE.PointLight(0xffffff, 10000, 0, 1); // Very high intensity for large distances
    pointLight.castShadow = true;
    pointLight.position.set(0, 0, 0);

    // Configure shadow properties for PointLight
    pointLight.shadow.mapSize.width = 4096; // Very high resolution
    pointLight.shadow.mapSize.height = 4096;
    pointLight.shadow.camera.near = 0.5; // PointLight does have near/far for each of its 6 cameras
    pointLight.shadow.camera.far = 999999999; // Needs to be large enough to cover your solar system
    ...
    renderer.outputColorSpace = THREE.SRGBColorSpace; // Set once here
...
export default SolarModelRenderer;
